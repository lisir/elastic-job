...
public final class CloudAppRestfulApiTest {
    ...
    public void assertRegisterWithBadRequest() throws Exception {
        assertThat(sentRequest("http://127.0.0.1:19001/app", "POST", "\"{\"appName\":\"wrong_app\"}"), is(500));
    }
    ...
    @Test
    public void assertDetailWithNotExistedApp() throws Exception {
        assertThat(sentRequest("http://127.0.0.1:19001/app/notExistedAppName", "GET", ""), is(500));
    }
    
    @Test
    public void assertFindAllApps() throws Exception {
